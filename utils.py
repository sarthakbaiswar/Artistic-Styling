...
class CONFIG:
    ...
    # Style image to use.
    STYLE_IMAGE = 'styles/style4.jpg'
    # Content image to use.
    CONTENT_IMAGE = 'content/emma1.png' 
...
def generate_noise_image(content_image, noise_ratio = CONFIG.NOISE_RATIO):
    ...
    noise_image = np.random.uniform(-70, 70, (1, CONFIG.IMAGE_HEIGHT, CONFIG.IMAGE_WIDTH, CONFIG.COLOR_CHANNELS)).astype('float32')
